        ...
        likePost: function likePost() {
            ...
            axios({
                ...
                if (response.data.status == "success") {
                    if (type == 'like') {
                        _this.dataLikeCount++;
                        _this.dataHasLiked = "true";
                    } else {
                        _this.dataLikeCount--;
                        _this.dataHasLiked = "false";
                    }
                    return;
                }
            });
...
Vue.component('commentForm', {
    ...
    methods: {
        setGifComment: function setGifComment(chosenGif) {
            console.log('###');
        ...
        toggleBrowseGifs: function toggleBrowseGifs() {
    ...
    methods: {
        doSearch: function doSearch() {
            ...
            axios.get('https://api.giphy.com/v1/gifs/search?q=' + this.criteria + '&api_key=' + this.apiKey + '&limit=' + this.limit).then(function (response) {
                console.log(response);
                _this2.loadGifs(response.data.data);
            });
        },
        ...
        unselectGif: function unselectGif() {
            this.selectedGif = '';
        },
